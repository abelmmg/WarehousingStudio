...
class Database:
    def __init__(self):
        ...
        self.warehouse = excel_data['Warehouse']
        ...
        self.requirements = pd.concat([self.requirements, self.inventory], ignore_index=True)
        self.requirements = pd.concat([self.requirements, self.inbound], ignore_index=True)
        ...
        self.requirements = self.requirements.fillna('')
